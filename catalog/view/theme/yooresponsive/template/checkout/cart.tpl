      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="quantity">
              <input type="image" src="catalog/view/theme/default/image/sub.png" title="Уменьшить" id="sub<?= $product['key'] ?>">
              <input type="text" size="1" name="quantity[<?= $product['key'] ?>]" value="<?= $product['quantity'] ?>" id="qty<?= $product['key'] ?>">
              <input type="image" src="catalog/view/theme/default/image/add.png" title="Увеличить" id="add<?= $product['key'] ?>">                                         
            </td>
            <td class="price"><?php echo $product['price']; ?></td>
            <td class="total"><?php echo $product['total']; ?></td>
            <td class="remove"><a href="<?= $product['remove']; ?>"><img src="catalog/view/theme/default/image/remove.png" alt="<?= $button_remove; ?>" title="<?= $button_remove; ?>"></a></td>
            <script type="text/javascript">
                $('#qty<?= $product['key'] ?>').live('blur', function() { $(this).closest('form').submit(); });
                
                $('#sub<?= $product['key'] ?>').live('click', function() {
                    $('#qty<?= $product['key'] ?>').attr('value', Number($('#qty<?= $product['key'] ?>').attr('value')) - 1);
                    $(this).closest('form').submit();
                });
                
                $('#add<?= $product['key'] ?>').live('click', function() {
                    $('#qty<?= $product['key'] ?>').attr('value', Number($('#qty<?= $product['key'] ?>').attr('value')) + 1);
                    $(this).closest('form').submit();
                });
            </script>
          ...
          <tr>
            ...
            <td class="quantity">
              ...
              <input type="text" name="" value="1" size="1" disabled="disabled" />&nbsp;<a href="<?php echo $vouchers['remove']; ?>"><img src="catalog/view/theme/default/image/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a></td>
